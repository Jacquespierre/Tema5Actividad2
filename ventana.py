...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(130, 360, 971, 221))
        ...
        self.actionImportarBackup = QtWidgets.QAction(MainWindow)
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap("Imagenes/importar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionImportarBackup.setIcon(icon9)
        self.actionImportarBackup.setObjectName("actionImportarBackup")
        self.actionCrearInforme = QtWidgets.QAction(MainWindow)
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap("Imagenes/informe.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionCrearInforme.setIcon(icon10)
        self.actionCrearInforme.setObjectName("actionCrearInforme")
        self.actionCrearBackup = QtWidgets.QAction(MainWindow)
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap("Imagenes/backup.png"), QtGui.QIcon.Normal, QtGui.QIcon.On)
        self.actionCrearBackup.setIcon(icon11)
        self.actionCrearBackup.setObjectName("actionCrearBackup")
        self.actionRecuperarBackup = QtWidgets.QAction(MainWindow)
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap("Imagenes/recuperar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionRecuperarBackup.setIcon(icon12)
        self.actionRecuperarBackup.setObjectName("actionRecuperarBackup")
        self.actionBorrarDatos = QtWidgets.QAction(MainWindow)
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap("Imagenes/borrar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionBorrarDatos.setIcon(icon13)
        ...
        self.menuHerramientas.addAction(self.actionImportarBackup)
        ...
        self.toolBar.addAction(self.actionImportarBackup)
        self.toolBar.addAction(self.actionSalir)

        self.retranslateUi(MainWindow)
        self.tabWidget.setCurrentIndex(0)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)
        MainWindow.setTabOrder(self.CampoDNI, self.CampoFecha)
        MainWindow.setTabOrder(self.CampoFecha, self.Calendario)
        MainWindow.setTabOrder(self.Calendario, self.CampoApellidos)
        MainWindow.setTabOrder(self.CampoApellidos, self.CampoNombre)
        MainWindow.setTabOrder(self.CampoNombre, self.spinEnvio)
        MainWindow.setTabOrder(self.spinEnvio, self.CampoApellidos_2)
        MainWindow.setTabOrder(self.CampoApellidos_2, self.comboBox)
        MainWindow.setTabOrder(self.comboBox, self.radioButtonFem_2)
        MainWindow.setTabOrder(self.radioButtonFem_2, self.radioButtonMas_2)
        MainWindow.setTabOrder(self.radioButtonMas_2, self.checkEfect_2)
        MainWindow.setTabOrder(self.checkEfect_2, self.checkTarjeta_2)
        MainWindow.setTabOrder(self.checkTarjeta_2, self.checkTransfe_2)
        MainWindow.setTabOrder(self.checkTransfe_2, self.Aceptar)
        MainWindow.setTabOrder(self.Aceptar, self.buscar)
        MainWindow.setTabOrder(self.buscar, self.modificar)
        MainWindow.setTabOrder(self.modificar, self.limpiar)
        MainWindow.setTabOrder(self.limpiar, self.actualizar)
        MainWindow.setTabOrder(self.actualizar, self.bajaClien)
        MainWindow.setTabOrder(self.bajaClien, self.tableWidget)
        MainWindow.setTabOrder(self.tableWidget, self.Salir)
        MainWindow.setTabOrder(self.Salir, self.tabWidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionImportarBackup.setText(_translate("MainWindow", "Importar Backup"))
        self.actionImportarBackup.setToolTip(_translate("MainWindow", "Importar"))
